    ...
    render() {
        ...
        return (
            <Row style={{ marginTop: '20px' }}>
                <ModalRentBike product={product}></ModalRentBike>
                <Col span={10}>
                    {
                        product.image &&
                        <img width="100%" alt="anh san pham" src={baseURL.backEndURLImage + `${product.image}`}></img>
                    }
                </Col>
                <Col span={1}></Col>
                <Col span={13}>
                    <p style={{ color: 'red', fontWeight: 'bold', fontSize: '40px' }}>
                        {product.name}
                    </p>
                    <div style={{
                        fontWeight: 'bold',
                    ...
                    </div>
                    {
                        this.props.user.username === '' ? (
                            <MDBBtn style={{ marginTop: '30px' }} disabled color="danger">
                                <MDBIcon far icon="times-circle" className="mr-1" />
                                Bạn phải đăng nhập để thuê xe!
                            </MDBBtn>
                        ) : (
                                <MDBBtn onClick={()=>this.props.openModalRentBike()} style={{ marginTop: '30px' }} color="primary">
                    ...
                    <div style={{ marginTop: '15px' }}>
                        <div className="fb-like" data-href="https://www.facebook.com/ithutech" data-layout="standard" data-action="like" data-size="small" data-show-faces="true" data-share="true" />
                    </div>
                    <div style={{ marginTop: '10px' }}>
                        <div className="fb-save" data-uri="https://www.facebook.com/ithutech" data-size="large" />
                ...
                <Col span={24}>
                    <Tabs defaultActiveKey="1">
                        <Tabs.TabPane
                            ...
                            key="1"
                        >
                            <p style={{margin: '15px', fontWeight: '400', fontSize: '18px'}}>
                                {product.description}
                            </p>
                        </Tabs.TabPane>
                    </Tabs>
