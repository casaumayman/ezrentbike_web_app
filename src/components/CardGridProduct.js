        ...
        return (
            <Card.Grid style={cardGridStyle}>
                ...
                <div style={{ textAlign: 'center' }}>
                    <p>
                        <b style={{ color: 'red', fontWeight: 'bold' }}>{`Giá: ${this.numberPrice(product.cost)} /ngày`}</b>
                        <Button style={{ marginLeft: '15px' }} onClick={() => rootHistory.push(`/product/${product.id}`)} type="primary">Xem chi tiết</Button>
                    </p>
                </div>
            </Card.Grid>
        )
